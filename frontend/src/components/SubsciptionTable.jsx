    ...
    <>
      <div className="card-container">
        {subs.map((s) => {
          ...
          return (
            <div className="sub-card" key={s._id}>
              <h3>{s.name}</h3>
              <p className="price">₹{s.price}</p>

              <p><strong>Start:</strong> {new Date(s.startDate).toDateString()}</p>
              <p><strong>End:</strong> {new Date(s.endDate).toDateString()}</p>
              ...
              <div className="card-buttons">
                ...
                <button className="delete-btn" onClick={() => del(s._id)}>
                  Delete
                </button>
              </div>
            </div>
